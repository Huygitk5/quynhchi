...
export default function FunLubricationPresentation() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-100 via-pink-100 to-yellow-100 flex items-center justify-center p-4 font-sans">
      <div className="bg-white/80 backdrop-blur-lg w-full max-w-4xl rounded-[2rem] shadow-2xl overflow-hidden border border-white">
        ...
        <div className="p-8 md:p-12 min-h-[500px] flex flex-col">
          ...
          <div className="mb-8 text-center flex-shrink-0">
            ...
            {slide.type === 'theory' ? (
              <h1 className="text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-orange-500 drop-shadow-sm">
                {slide.title}
              </h1>
            ) : (
